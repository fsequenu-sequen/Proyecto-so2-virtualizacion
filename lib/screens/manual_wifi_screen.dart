  ...
  Future<void> _probarConexion() async {
    ...
    unawaited(
      EventLogService.instance.log(
        ...
        success: ok,
        detail: ok
            ? 'Ping al ESP32S en ${_robot.baseUrl}'
            : 'Sin respuesta al ping en ${_robot.baseUrl}',
      ),
    );
  ...
  Future<void> _enviarAsync(String comando) async {
    ...
    unawaited(
      EventLogService.instance.log(
        ...
        success: ok,
        detail: ok
            ? 'Comando HTTP al ESP32S'
            : 'Fallo al enviar comando al ESP32S',
      ),
    );
  ...
  Future<void> _seguroParar() async {
    ...
    unawaited(
      EventLogService.instance.log(
        ...
        action: 'todo:parar',
        success: ok,
        detail: ok ? 'Parada segura enviada' : 'Fallo parada segura',
      ),
    );
